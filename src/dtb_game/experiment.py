...
Game equations live in ``dynamics.py``. This module owns initialization, the DTB
...
from .integrators import (
    advance_score, dtb_step, rk4_flow, rk4_step,
    _advance_reference, _reference_method, _validate_velocity,
)
